<template>
  <div id="home">
    ...
    <div class="parallax-star" style="top: 25%; left: 10%; animation-delay: 10s;"></div>
    <div class="parallax-star" style="top: 35%; left: 20%; animation-delay: 11s;"></div>
    <div class="parallax-star" style="top: 45%; left: 30%; animation-delay: 12s;"></div>
    <div class="parallax-star" style="top: 55%; left: 40%; animation-delay: 13s;"></div>
    <div class="parallax-star" style="top: 65%; left: 50%; animation-delay: 14s;"></div>
    <div class="parallax-star" style="top: 75%; left: 60%; animation-delay: 15s;"></div>
    ...
    <div class="star-ray" style="top: 23%; left: 23%; animation-delay: 10s;"></div>
    <div class="star-ray" style="top: 33%; left: 33%; animation-delay: 11s;"></div>
    <div class="star-ray" style="top: 43%; left: 43%; animation-delay: 12s;"></div>
    <div class="star-ray" style="top: 53%; left: 53%; animation-delay: 13s;"></div>
    <div class="star-ray" style="top: 63%; left: 63%; animation-delay: 14s;"></div>
    <div class="star-ray" style="top: 73%; left: 73%; animation-delay: 15s;"></div>
    <div class="star-ray" style="top: 83%; left: 83%; animation-delay: 16s;"></div>
    <div class="star-ray" style="top: 93%; left: 93%; animation-delay: 17s;"></div>
    
    <!-- Additional Star Rays -->
    <div class="star-ray" style="top: 11%; left: 21%; animation-delay: 0.5s;"></div>
    <div class="star-ray" style="top: 21%; left: 31%; animation-delay: 1.5s;"></div>
    <div class="star-ray" style="top: 31%; left: 41%; animation-delay: 2.5s;"></div>
    <div class="star-ray" style="top: 41%; left: 51%; animation-delay: 3.5s;"></div>
    <div class="star-ray" style="top: 51%; left: 61%; animation-delay: 4.5s;"></div>
    <div class="star-ray" style="top: 61%; left: 71%; animation-delay: 5.5s;"></div>
    <div class="star-ray" style="top: 71%; left: 81%; animation-delay: 6.5s;"></div>
    <div class="star-ray" style="top: 81%; left: 91%; animation-delay: 7.5s;"></div>
    <div class="star-ray" style="top: 91%; left: 3%; animation-delay: 8.5s;"></div>
    <div class="star-ray" style="top: 16%; left: 26%; animation-delay: 9.5s;"></div>
    <div class="star-ray" style="top: 26%; left: 36%; animation-delay: 10.5s;"></div>
    <div class="star-ray" style="top: 36%; left: 46%; animation-delay: 11.5s;"></div>
    <div class="star-ray" style="top: 46%; left: 56%; animation-delay: 12.5s;"></div>
    <div class="star-ray" style="top: 56%; left: 66%; animation-delay: 13.5s;"></div>
    <div class="star-ray" style="top: 66%; left: 76%; animation-delay: 14.5s;"></div>
    <div class="star-ray" style="top: 76%; left: 86%; animation-delay: 15.5s;"></div>
    <div class="star-ray" style="top: 86%; left: 96%; animation-delay: 16.5s;"></div>
    <div class="star-ray" style="top: 96%; left: 6%; animation-delay: 17.5s;"></div>
        ...
        <div class="hero-content">
          <div class="hero-text">
            ...
            <div class="cta-buttons">
              <button class="btn btn-primary" @click="primaryCtaClick">{{ isAuthed ? 'Go to Dashboard' : "Get Started - It's Free" }}</button>
            </div>
          </div>
          <div class="hero-visual">
            <div class="ai-comments">
              <div class="comment comment-1">
                ...
                <div class="comment-text">AI comment suggesting content improvements</div>
              </div>
              <div class="comment comment-2">
                <div class="comment-icon">✏️</div>
                <div class="comment-text">AI comment suggesting content improvements</div>
              </div>
            </div>
    ...
    <section class="trusted-by">
      <div class="container">
        ...
        <div class="logos-grid">
          ...
          <div class="logo-item fade-in-on-scroll">Goldman Sachs</div>
          <div class="logo-item fade-in-on-scroll">MIT</div>
          <div class="logo-item fade-in-on-scroll">McKinsey</div>
          <div class="logo-item fade-in-on-scroll">Yale University</div>
          <div class="logo-item fade-in-on-scroll">Deloitte</div>
          <div class="logo-item fade-in-on-scroll">Duke University</div>
          <div class="logo-item fade-in-on-scroll">Northwestern University</div>
          <div class="logo-item fade-in-on-scroll">UT Austin</div>
        </div>
      </div>
    </section>
          ...
          <div class="feature-card slide-in-left-on-scroll">
            <div class="feature-visual">
              ...
              <div class="feature-preview">
                <div class="preview-item">PDF</div>
                <div class="preview-item">Video</div>
                <div class="preview-item">Audio</div>
                <div class="arrow neon-glow">→</div>
                <div class="notes neon-glow">Editable Notes</div>
              </div>
            </div>
            <h3>Turn anything into an editable note.</h3>
            <p>Transform PDFs, videos, and audio into notes you can edit and share.</p>
          </div>

          <div class="feature-card slide-in-right-on-scroll">
            <div class="feature-visual">
              <div class="collaboration-demo">
                <div class="doc-editing">
                  <div class="editing-cursor neon-glow"></div>
                  <div class="ai-highlight neon-glow"></div>
                  <div class="ai-comment-bubble neon-glow">AI comment here</div>
                </div>
              </div>
            </div>
          ...
          <div class="feature-card slide-in-left-on-scroll">
            <div class="feature-visual">
              <div class="study-tools">
                <div class="tool neon-glow">Quiz</div>
                <div class="tool neon-glow">Flashcards</div>
                <div class="tool neon-glow">Podcast</div>
              </div>
            </div>
            <h3>Study smarter, not harder.</h3>
            <p>Formerly, SpeakLearn - students love us. Generate quizzes, podcasts, flashcards from your notes.</p>
          </div>

          <div class="feature-card slide-in-right-on-scroll">
            <div class="feature-visual">
              <div class="devices">
                <div class="device laptop floating">💻</div>
                <div class="device tablet floating">📱</div>
                <div class="device phone floating">📱</div>
                <div class="sync-lines">
                  <div class="sync-line neon-glow"></div>
                  <div class="sync-line neon-glow"></div>
                  <div class="sync-line neon-glow"></div>
                </div>
              </div>
    ...
    <section class="testimonials">
      <div class="container">
        <h2 class="section-title fade-in-on-scroll">Testimonials</h2>
      ...
      <div class="container">
        <div class="footer-content">
          ...
          <div class="footer-section">
            <h4>Company</h4>
            <ul>
              <li><a href="#" @click="goToSignup">Sign Up</a></li>
